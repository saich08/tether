...
export function TitleBar({
  ...
  return (
    <div
      className={`flex items-center justify-between ${isMac ? "pl-20 pr-4" : "pl-4 pr-36"} h-10 bg-surface-950 border-b border-surface-800 select-none flex-shrink-0`}
      style={{ WebkitAppRegion: "drag" } as React.CSSProperties}
    >
      {/* Left: app branding (Windows/Linux only) */}
      {isMac ? <div /> : <AppBranding />}
      ...
      {/* Right: actions (+ app branding on Mac) */}
      <div
