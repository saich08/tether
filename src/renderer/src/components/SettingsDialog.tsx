        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-surface-800">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-surface-500">Customize your Tether experience</p>
            </div>
          </div>
          <button className="btn-ghost p-1.5 rounded-lg" onClick={onClose} title="Close">
              ...
              {THEMES.map((t) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Label */}
                    <span className={`text-xs font-medium pb-0.5 ${isActive ? 'text-surface-100' : 'text-surface-400 group-hover:text-surface-300'}`}>
                      {t.name}
                    </span>
                  </button>
                )
